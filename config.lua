-- TeamWar OT Server Config

	-- Account manager
	accountManager = true
	namelockManager = true
	newPlayerChooseVoc = true
	newPlayerSpawnPosX = 1351
	newPlayerSpawnPosY = 1898
	...
	maxPlayers = 1000
	motd = "Welcome to the TeamWarOT!"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = 0
	serverName = "TeamWarOT"
	loginMessage = "Welcome to the TeamWarOT!"
	...
	sqlUser = "root"
	sqlPass = ""
	sqlDatabase = "teamwar-public"
	sqlFile = "Teamwar-Public-SQLite.s3db"
	sqlKeepAlive = 0
	mysqlReadTimeout = 10
